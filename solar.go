...
// calculateSolarTimes returns sunrise and sunset times for a given location and date
func calculateSolarTimes(lat, lon float64, t time.Time) (sunrise, sunset time.Time) {
...
func julianDay(t time.Time) float64 {
	...
	// Add day fraction for time of day
